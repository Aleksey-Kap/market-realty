# Generated by Django 3.1.3 on 2020-12-06 19:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='city',
            options={'verbose_name': 'Тип Город (для выборки)', 'verbose_name_plural': 'Тип Города (для выборки)'},
        ),
        migrations.AlterModelOptions(
            name='country',
            options={'verbose_name': 'Тип Страна', 'verbose_name_plural': 'Тип Страны'},
        ),
        migrations.AlterModelOptions(
            name='region',
            options={'verbose_name': 'Тип Регион (для выборки)', 'verbose_name_plural': 'Тип Регионы (для выборки)'},
        ),
        migrations.AddField(
            model_name='city',
            name='pid',
        ...
        migrations.AddField(
            model_name='mertoline',
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='flat.city'),
        ),
        migrations.CreateModel(
            name='Flatmetro',
            fields=[
        ...
        migrations.AddField(
            model_name='flat',
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='flat.city', verbose_name='Город'),
        ),
        migrations.AddField(
            model_name='flat',
            name='freeplan',
